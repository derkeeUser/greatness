...
!function () {
    ...
    var e = window.layui && layui.define, t = {
            ...
            v: "5.0.2", config: {}, index: window.laydate && window.laydate.v ? 1e5 : 0, path: t.getPath, set: function (e) {
                var n = this;
        ...
        c = "layui-laydate-list", m = "laydate-selected", u = "layui-laydate-hint", h = "laydate-day-prev", y = "laydate-day-next",
        f = "layui-laydate-footer", p = ".laydate-btns-confirm", g = "laydate-time-text", v = ".laydate-btns-time", D = function (e) {
            var t = this;
    ...
    w.prototype = [], w.prototype.constructor = w, T.extend = function () {
        ...
        var t, a, i, r = this, s = r.config, l = e || s.dateTime, c = new Date, m = r.lang(), u = "date" !== s.type && "datetime" !== s.type,
            h = e ? 1 : 0, y = T(r.table[h]).find("td"), f = T(r.elemHeader[h][2]).find("span");
        ...
        var n = this, a = n.config, i = a.dateTime, r = n.lang(), l = a.range && "date" !== a.type && "datetime" !== a.type,
            ...
            m = n.elemHeader[t], u = T(m[2]).find("span"), h = n.elemCont[t || 0], y = T(h).find("." + c)[0], f = "cn" === a.lang, D = f ? "年" : "",
            w = n.listYM[t] || {}, C = ["hours", "minutes", "seconds"], x = ["startTime", "endTime"][t];
        if (w[0] < 1 && (w[0] = 1), "year" === e) {
            ...
            e + 1 == w[1] && T(a).addClass(o), a.innerHTML = r.month[e] + (f ? "月" : ""), d.appendChild(a), n.limit(T(a), {year: w[0], month: e}, t)
            ...
            a.range ? n[x] || (n[x] = {hours: 0, minutes: 0, seconds: 0}) : n[x] = i, T.each([24, 60, 60], function (e, t) {
        ...
        var t = this, n = t.config, a = e ? T.extend({}, t.endDate, t.endTime) : n.range ? T.extend({}, t.startDate, t.startTime) : n.dateTime,
            i = t.format.concat();
        ...
        if (r = {year: 0 | r[0], month: (0 | r[1]) - 1, date: 0 | r[2]}, !e.hasClass(s)) if (n.range) {
            if (T.each(["startTime", "endTime"], function (e, n) {
                ...
                if (e.addClass(o), t.endDate ? T.extend(t.endDate, r) : t.endDate = T.extend({}, r, t.endTime), t.newDate(r).getTime() < t.newDate(t.startYMD).getTime()) {
                    var d = T.extend({}, t.endDate, {hours: t.startDate.hours, minutes: t.startDate.minutes, seconds: t.startDate.seconds});
        ...
        return {
            prevYear: function () {
                ...
                T.extend(a, {year: e[0], month: e[1]}), t.checkDate("limit").calendar(), n.range || t.done(null, "change")
            }, nextMonth: function () {
...
layui.define("jquery", function (i) {
    ...
    var o = ".layui-nav", c = "layui-nav-item", r = "layui-nav-bar", u = "layui-nav-tree", d = "layui-nav-child", h = "layui-nav-more",
        f = "layui-anim layui-anim-upbit", y = {
            tabClick: function (i, t, s) {
                var o = s || a(this), t = t || o.parent().children("li").index(o), c = o.parents(".layui-tab").eq(0),
                    r = c.children(".layui-tab-content").children(".layui-tab-item"), u = o.find("a"), d = c.attr("lay-filter");
                ...
                var i = a(this), t = i.find(".layui-colla-icon"), e = i.siblings(".layui-colla-content"), s = i.parents(".layui-collapse").eq(0),
                    o = s.attr("lay-filter"), c = "none" === e.css("display");
                ...
                a(o).each(function (t) {
                    ...
                    o.find("." + r)[0] || (o.append(f), v.on("mouseenter", function () {
                        ...
                        clearTimeout(l[t]), s[t] = setTimeout(function () {
                            o.hasClass(u) ? f.css({height: 0, top: f.position().top + f.height() / 2, opacity: 0}) : f.css({
                                width: 0,
...
layui.define("layer", function (e) {
    "use strict";
    var i = layui.$, t = layui.layer, a = layui.hint(), n = layui.device(), l = "form", s = ".layui-form", r = "layui-this", u = "layui-hide",
        c = "layui-disabled", o = function () {
            this.config = {
                verify: {
                    required: [/[\S]+/, "必填项不能为空"],
    ...
    o.prototype.set = function (e) {
        ...
        var n = this, o = i(s + function () {
            ...
            select: function () {
                var e, t = "请选择", a = "layui-form-select", n = "layui-select-title", s = "layui-select-none", d = "", f = o.find("select"),
                    y = function (t, l) {
    ...
    var d = function () {
        var e = i(this), a = f.config.verify, r = null, u = "layui-form-danger", c = {}, o = e.parents(s), d = o.find("*[lay-verify]"),
            y = e.parents("form")[0], v = o.find("input,select,textarea"), h = e.attr("lay-filter");
...
layui.define("layer", function (e) {
    ...
    f.prototype.config = {
        ...
        var e = this, t = e.config, n = i('<iframe id="' + c + '" class="' + c + '" name="' + c + '" frameborder="0"></iframe>'),
        ...
        var o, a = this, l = a.config, r = a.elemFile[0], u = function () {
            layui.each(e || a.files || a.chooseFiles || r.files, function (e, t) {
                ...
                n.append(l.field, t), layui.each(l.data, function (e, i) {
                    ...
                    url: l.url, type: l.method, data: n, contentType: !1, processData: !1, dataType: "json", success: function (i) {
                        d(e, i)
                    }, error: function () {
...
layui.define(["laytpl", "laypage", "layer", "form"], function (e) {
    ...
    var t = layui.$, i = layui.laytpl, a = layui.laypage, l = layui.layer, n = layui.form, d = layui.hint(), c = layui.device(), r = {
            config: {checkName: "LAY_CHECKED"}, cache: {}, index: layui.table ? layui.table.index + 1e4 : 0, set: function (e) {
                var i = this;
        ...
        }, s = "table", u = ".layui-table", f = "layui-hide", h = "layui-table-view", y = ".layui-table-header", p = ".layui-table-body",
        v = ".layui-table-main", m = ".layui-table-fixed", x = ".layui-table-fixed-l", b = ".layui-table-fixed-r", g = ".layui-table-tool",
        k = ".layui-table-sort", C = "layui-table-edit", w = "layui-table-hover", z = function (e) {
    ...
    j.prototype.config = {limit: 30, loading: !0}, j.prototype.render = function () {
        ...
        f.on("mousemove", function (e) {
            ...
            var e = t(this).prev(), i = a.layBody.find('input[name="layTableCheckbox"]'), l = e.parents("tr").eq(0).data("index"), d = e[0].checked,
            ...
            layui.event.call(this, s, "tool(" + y + ")", {
                data: r.cache[a.key][l], event: e.attr("lay-event"), tr: n, del: function () {
                    var e = this.data;
...
layui.define("jquery", function (e) {
    ...
    var i = layui.$, n = (layui.hint(), layui.device(), {
        ...
        }), t = "carousel", a = "layui-this", o = ">*[carousel-item]>*", l = "layui-carousel-left", r = "layui-carousel-right", d = "layui-carousel-prev",
...
layui.define("jquery", function (e) {
    ...
    var o = layui.$, t = {
        fixbar: function (e) {
            ...
            var a = this, i = "function" == typeof o, l = new Date(e).getTime(), r = new Date(!o || i ? (new Date).getTime() : o).getTime(),
                c = l - r, n = [Math.floor(c / 864e5), Math.floor(c / 36e5) % 24, Math.floor(c / 6e4) % 60, Math.floor(c / 1e3) % 60];
            i && (t = o);
...
layui.define(["layer", "form"], function (t) {
    ...
    c.prototype.set = function (t) {
        ...
        i = i || {};
        var a = this, n = a.config, r = "layui-layedit", c = e("#" + t), u = "LAY_layedit_" + ++a.index, d = c.next("." + r), y = e.extend({}, n, i),
            f = function () {
                var t = [], e = {};
